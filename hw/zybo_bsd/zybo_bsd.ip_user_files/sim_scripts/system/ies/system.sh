...
execute()
{
  irun $irun_opts \
       ...
       -top glbl \
       glbl.v \
       +incdir+"$ref_dir/../../../../zybo_bsd.srcs/sources_1/bd/system/ipshared/ec67/hdl" \
       +incdir+"$ref_dir/../../../../zybo_bsd.srcs/sources_1/bd/system/ipshared/f8d8/hdl" \
       +incdir+"$ref_dir/../../../../zybo_bsd.srcs/sources_1/bd/system/ipshared/02c8/hdl/verilog" \
       +incdir+"$ref_dir/../../../../zybo_bsd.srcs/sources_1/bd/system/ipshared/1313/hdl" \
       +incdir+"../../../../zybo_bsd.srcs/sources_1/bd/system/ipshared/ec67/hdl" \
       +incdir+"../../../../zybo_bsd.srcs/sources_1/bd/system/ipshared/f8d8/hdl" \
       +incdir+"../../../../zybo_bsd.srcs/sources_1/bd/system/ipshared/02c8/hdl/verilog" \
       +incdir+"../../../../zybo_bsd.srcs/sources_1/bd/system/ipshared/1313/hdl" \
